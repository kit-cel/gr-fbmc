...
# Title: Rx 2017
# Generated: Fri Mar  3 13:43:53 2017
##################################################
...
class RX_2017(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fbmc_subchannel_deframer_vcb_0 = fbmc.subchannel_deframer_vcb(cfg.num_total_subcarriers(), nchan, nguard_bins, 0.9, (sync.get_preamble_symbols()), sync.get_syms_frame(), cfg.num_payload_bits(), (sync.get_pilot_carriers()), sync.get_pilot_timestep())
        ...
        self.connect((self.fbmc_subchannel_deframer_vcb_0, 0), (self.blocks_pack_k_bits_bb_0, 0))    
    ...
    def set_fine_frequency_correction(self, fine_frequency_correction):
        ...
        self.uhd_usrp_source_0.set_center_freq(self.cfreq+self.fine_frequency_correction, 0)
