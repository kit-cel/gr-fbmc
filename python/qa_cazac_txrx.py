...
class qa_tx_rx(gr_unittest.TestCase):
    def setUp(self):
        ...
        self.tb.connect((self.tb.fbmc_channel_estimator_vcvc_0, 1), (self.tb.fbmc_channel_equalizer_vcvc_0, 1))
        self.tb.connect((self.tb.fbmc_channel_estimator_vcvc_0, 0), (self.tb.fbmc_channel_equalizer_vcvc_0, 0))
